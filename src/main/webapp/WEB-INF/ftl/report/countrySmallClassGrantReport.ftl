...
<head>
    <meta charset="utf-8"/>
    <title>辽宁省林业厅生态公益林管理系统-国家公益林发放面积小于小班面积统计表</title>
            ...
            <div class="col-sm-12">
                <div class="table">
                    <table id="example" class="table table-striped table-bordered" cellspacing="0" width="100%">
                        ...
                        <tr>
                            <div class="col-lg-9">
                                <strong id="tableTitle">国家公益林发放面积小于小班面积统计表</strong>
...
<script type="text/javascript">
    ...
    var tableTitle = nowYear + "年度国家公益林发放面积小于小班面积统计表";
    ...
    function itemOnclick(target) {
        ...
        var tableTitle = nodeName + yearSelect + "年度国家公益林发放面积小于小班面积统计表";
        $("#tableTitle").html(tableTitle);
        if (node.state.expanded) {
            //处于展开状态则折叠
            tree.treeview('collapseNode', node.nodeId);
