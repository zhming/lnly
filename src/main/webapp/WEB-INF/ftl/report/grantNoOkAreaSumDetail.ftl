...
<head>
    <meta charset="utf-8"/>
    <title>辽宁省林业厅生态公益林管理系统-国家及地方直补到户资金未发放明细</title>
            ...
            <div class="col-sm-12">
                <div class="table">
                    <table id="example" class="table table-striped table-bordered" cellspacing="0" width="100%">
                        ...
                        <tr>
                            <div class="col-lg-9">
                                <strong id="tableTitle">2017年度国家及地方直补到户资金未发放明细</strong>
...
<script type="text/javascript">
    ...
    <@shiro.hasPermission name="/adminDict/findDictTree.shtml">
        ...
        $("#example").dataTable({
            ...
            ajax: {//类似jquery的ajax参数，基本都可以用。
                ...
                url: "${basePath}/countryDetail/findNoOkAll.shtml",
    ...
    function itemOnclick(target) {
        ...
        var tableTitle = nodeName + yearSelect + "年度国家及地方直补到户资金未发放明细";
