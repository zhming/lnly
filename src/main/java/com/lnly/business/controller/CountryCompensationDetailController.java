...
public class CountryCompensationDetailController extends BaseController {
    ...
    @Resource
    CountryCompensationDetailService countryCompensationStandardService;
    ...
    public Map<String,Object> findOne(Long id){
        ...
        CountryCompensationDetail countryCompensationStandard = countryCompensationStandardService.selectByPrimaryKey(id);
    ...
    public Map<String,Object> getAllPost(BcbzPageEntity param){
        ...
        try {
            Pagination<CountryCompensationDetail> pagination =  countryCompensationStandardService.findByPage(map, param.getiDisplayStart(), param.getiDisplayLength());
            if(null != pagination){
    ...
    public Map<String,Object> update(CountryCompensationDetail entity){
        try {
            countryCompensationStandardService.updateByPrimaryKey(entity);
            resultMap.put("status", 200);
    ...
    public Map<String, Object> findAll(ModelMap modelMap, PageEntity pageEntity){
        ...
        Pagination<CountryCompensationDetail> pagination = countryCompensationStandardService.findByPage(modelMap, pageEntity.getiDisplayStart(),pageEntity.getiDisplayLength());
